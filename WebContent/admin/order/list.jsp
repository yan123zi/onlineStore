	...
	<HEAD>
		...
		function createXmlHttp(){
			...
			function showDetail(oid){
				...
				var btn=document.getElementById("but"+oid);
				var div=document.getElementById("div"+oid);
				if(btn.value=="订单详情"){
				xhr.onreadystatechange=function(){
					if(xhr.readyState==4&&xhr.status==200){
						
						div=document.getElementById("div"+oid);
										...
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<s:if test="#order.state==2">
													<a href="${pageContext.request.contextPath}/adminOrder_update.action?oid=<s:property value="#order.oid"/>"><font color="blue">发货</font></a>
												</s:if>
