...
$(function(){
	...
	$("#checkImg").click(function(){
		$(this).attr("src","${pageContext.request.contextPath}/CheckImg.action?"+new Date().getTime());
	});
});
</script>
</head>
	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/未命名-1.png" alt="网上商城">
			</a>
		</div>
	</div>
	<div class="span9">
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkCode" class="text" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/CheckImg.action" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
