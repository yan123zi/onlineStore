		...
		<div class="span5">
			<div class="logo">
				<a href="./网上商城/index.htm"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/未命名-1.png"
					alt="网上商城" /> </a>
			</div>
		</div>
		<div class="span9">
						...
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<s:if test="#order.state == 3">
									<a href="${ pageContext.request.contextPath }/order_updateState.action?oid=<s:property value="#order.oid" />"><font color="yellow">确认收货</font></a>
								</s:if>
